...
Prose and style influences: Mario Zechner, Rob Pike, Brian Kernighan.
...
- Use Conventional Commits. Titles and descriptions should both be 72 characters max, and descriptions should be one short paragraph at most hard-wrapped at that length.
