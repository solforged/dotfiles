-- USGC-derived TUI themes; palettes are generated by desktop/reticle/generate.py.
-- See desktop/reticle/README.md for provenance, semantic roles, and contrast.
-- No italics. Text and borders use separate contrast levels.

local M = {}

M.palettes = require("reticle.palettes")
...
-- On a dark terminal, choose "dark", "dimmed", or "polyimide".
function M.load(variant, name)
  if not variant then
    variant = vim.o.background == "light" and "light" or (vim.g.usgc_reticle_dark or "dimmed")
  end
